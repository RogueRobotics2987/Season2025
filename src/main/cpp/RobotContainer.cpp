...
RobotContainer::RobotContainer()
{
    ...
    NamedCommands::registerCommand("RightLineUp", std::move(RightSideApriltagReefLineup(drivetrain, -0.16, 0.42, 6).ToPtr())); //boot loops the robot
    NamedCommands::registerCommand("LeftLineUp", std::move(RightSideApriltagReefLineup(drivetrain, 0.17, 0.4, 0.46).ToPtr())); //boot loops the robot
