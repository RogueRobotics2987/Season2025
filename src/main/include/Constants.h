...
namespace CoralSubsystemConstants {
    ...
    inline constexpr double L1Height = 0; //elevator height is in inches
    ...
    // inline constexpr double rightBranchSetPointX = -0.2;
    // inline constexpr double rightBranchSetPointY = 0.35;
